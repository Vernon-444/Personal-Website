...
export default function Footer() {
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl  pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700">
          <div>
          </div>
          <div className="">
            <div>Connect</div>
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              <a
                href="https://linkedin.com/in/brayden-vernon"
                target="_blank"
                rel="noopener">
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Made with ♥ by Brayden Vernon 12-2023
        </div>
      </Container>
    </div>
  );
