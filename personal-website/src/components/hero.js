...
const Hero = () => {
  ...
  useEffect(() => {
    const cursorTimeout = setInterval(() => {
      setIsCursorVisible((isCursorVisible) => !isCursorVisible);
      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          ...
          <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
            {texts[textIndex].substring(0, charIndex)}{isCursorVisible && '|'}
          </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Tulsa-based full-stack web developer with a passion for building beautiful, functional, and responsive web applications. I am a self-motivated, detail-oriented, and hard-working individual who is always looking to learn and grow. I am currently seeking a full-time position as a web developer, and I am open to relocation and remote work. Learn more about me below, download my resume, or contact me to get in touch.
            </p>
